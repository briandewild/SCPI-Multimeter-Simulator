...
2. Run client.py
3. Client runs through series of sequential test queries and commands, returning values in an RLC circuit: *IDN?, MEASU:IMM:TYP VDC, MEASU:IMM:TYP VDC?,
MEASU:IMM:TYP IDC?, MEASU:IMM:TYP IDC, and MEASU:IMM:TYP IDC?
